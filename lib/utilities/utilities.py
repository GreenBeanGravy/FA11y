...
Open Quest Browser = lalt+q "Browse quests, progress, and completion across modes using your Epic login, before or during a match."
...
Open Discovery GUI = lalt+apostrophe "Open the discovery GUI for browsing Creative islands and gamemodes."
